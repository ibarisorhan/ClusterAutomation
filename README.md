...
(6) bash Run.sh while in the RASPA_Automation directory (Optional: From the "Others" folder, the PBS_1.txt task can be moved to the RASPA automation folder and sent to queue. This will recursively call itself to run Run.sh in the time frame in the script!)
